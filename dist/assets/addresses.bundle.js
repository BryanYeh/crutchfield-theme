...
ready(function () {
  ...
  document.querySelector('.las.la-bars').addEventListener('click', function (e) {
    ...
    document.querySelector('nav').parentNode.classList.toggle('hidden'); // if(open === true){
...
addressForms.forEach(function (form) {
  (0,_shopify_theme_addresses__WEBPACK_IMPORTED_MODULE_1__.AddressForm)(form, 'en');
});
...
document.querySelectorAll('.address-edit').forEach(function (edit_button) {
  edit_button.addEventListener('click', function (e) {
    var address_form = document.querySelector('.address-edit-form');
...
/******/ 	// startup
/******/ 	// Load entry module
/******/ 	__webpack_require__("./src/js/templates/addresses.js");
